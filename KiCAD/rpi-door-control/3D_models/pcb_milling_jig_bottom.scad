...
difference() {
   ...
   union() {
      ...
      cylinder(h = z_pillar, r = screw_size * 1.5);
      translate([x, 0, 0]) cylinder(h = z_pillar, r = screw_size * 1.5);
      translate([0, y, 0]) cylinder(h = z_pillar, r = screw_size * 1.5);
      translate([x, y, 0]) cylinder(h = z_pillar, r = screw_size * 1.5);
      translate([x / 2, 0, 0]) cylinder(h = z_pillar, r = screw_size * 1.5);
      translate([x / 2, y, 0]) cylinder(h = z_pillar, r = screw_size * 1.5);
   } /* endunion */
   

   translate([0, 0, 0]) {
      nutHole(size=4, tolerance=0.2);
      cylinder(h = z_pillar, r = screw_size / 2);
   } /* endtranslate */
